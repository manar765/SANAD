...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document
        ...
        .forEach((link) => {
            ...
            link.classList.toggle(
                'active',
                hrefPage === currentPage && !isSectionLink
            );
    ...
    if (!navbar) {
        console.warn("Navbar element #navbar was not found; skipping navbar-only features.");
    }
    ...
    document
        ...
        .forEach((link) => {
            ...
            link.addEventListener('click', (event) => {
                ...
                const page =
                    link.dataset.page || 'هذه الخدمة';


                showToast(
                    `قريباً … صفحة «${page}» قيد الإعداد`
                );
